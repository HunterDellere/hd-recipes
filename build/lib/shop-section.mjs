...
const BUCKETS = {
  produce: [
    ...
    'king-oyster-mushroom', 'okra', 'orange', 'oyster-mushroom', 'pandan-leaves', 'parsley', 'pear',
  ...
  meat: [
    ...
    'cod', 'dungeness-crab', 'ground-beef', 'ground-lamb', 'ground-pork', 'halibut',
  ...
  spices: [
    ...
    'fennel-seed', 'flaky-salt', 'garam-masala', 'gochugaru', 'green-cardamom',
    'ground-coriander', 'ground-cumin', 'hungarian-paprika',
    'kashmiri-chili-powder', 'mexican-oregano', 'monosodium-glutamate',
    'mustard-seeds', 'nigella-seeds', 'poppy-seeds', 'red-pepper-flakes', 'saffron',
  ...
  pantry: [
    ...
    'balsamic-vinegar', 'banana-ketchup', 'banh-trang', 'barley-malt-syrup',
    'basmati-rice', 'black-beans',
    ...
    'fish-sauce', 'flax-seeds', 'gelatin', 'genmaicha', 'glutinous-rice', 'glutinous-rice-flour',
    'green-tea-leaves',
    'gochujang', 'granulated-sugar', 'hazelnut', 'high-gluten-flour',
    'hoisin-sauce', 'hominy',
    ...
    'rock-sugar', 'rolled-oats', 'rye-flour', 'sake', 'sauerkraut',
    'sencha', 'sesame-paste', 'shanghai-noodles',
    'shaoxing-wine', 'sodium-alginate', 'sui-mi-ya-cai',
    'sunflower-seeds', 'sweetened-condensed-milk', 'tahini', 'tamarind', 'tapioca-pearls',
    ...
    'white-wine-vinegar', 'whole-wheat-flour', 'wood-ear-mushroom',
    'worcestershire-sauce', 'yellow-split-peas', 'yuzu',
  ],
};
