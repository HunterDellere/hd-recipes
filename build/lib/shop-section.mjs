...
const BUCKETS = {
  ...
  pantry: [
    ...
    'dende-oil', 'desiccated-coconut', 'dijon-mustard', 'doubanjiang',
    'douchi', 'dried-porcini', 'dried-shiitake', 'dried-shrimp', 'dry-sherry',
...
const KEYWORD_RULES = [
  ...
  { section: 'pantry', test: t => /\b(baking powder|baking soda|yeast|cream of tartar|gelatin|agar|cocoa|chocolate|vanilla extract|food coloring|cornflake|crouton|crumb|panko|breadcrumb|graham cracker)\b/.test(t) },
