...
modifications:
  - for: 'protein'
    ...
    kind: 'protein'
  - for: 'protein'
    to: 'chicken breast, sliced and velveted (techniques/chicken-breast-for-thai-curry)'
    how: 'Slice 450 g of breast across the grain at 4-5 mm, velvet 20-30 minutes with 1% kosher salt, 1.5 g baking soda, and 8 g cornstarch in a loose fish-sauce slurry. Substitute step-for-step for the pork in Phase 3: temper, add to the simmer, cook 3-4 minutes to 145F internal, pull off heat, and use the reserved cold cream finish to halt carryover at 150F. Breast has no collagen and no marbling, so the technique page covers the thermal control needed to keep it tender.'
    kind: 'protein'
  - for: 'dietary'
    to: 'vegetarian'
