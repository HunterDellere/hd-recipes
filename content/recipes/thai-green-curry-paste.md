...
ingredients:
  - group: 'Aromatic base'
    ...
    qty: 30
    unit: 'g'
    note: '(~15 chilies, adjust for heat)'
  - group: 'Aromatic base'
    item: 'green serrano or long green chilies, seeded'
    qty: 60
    unit: 'g'
    note: '(2 chilies, for green color and bulk)'
  - group: 'Aromatic base'
    item: 'lemongrass, white part only, sliced thin'
    qty: 45
    unit: 'g'
    note: '(3 stalks)'
  - group: 'Aromatic base'
    item: 'fresh galangal, peeled and sliced thin'
    qty: 20
    unit: 'g'
    note: '(1.5-inch knob)'
  - group: 'Aromatic base'
    item: 'makrut lime zest'
    qty: 4
    unit: 'g'
    note: '(2 tsp, from 2 limes; or 6 makrut leaves stripped of stem)'
  - group: 'Aromatic base'
    item: 'fresh coriander root (or lower stems)'
    qty: 10
    unit: 'g'
    note: '(1 tbsp chopped)'
  - group: 'Aromatic base'
    ...
    note: '(8 cloves)'
  - group: 'Aromatic base'
    item: 'Thai shallots (or French), peeled'
    qty: 50
    unit: 'g'
    note: '(4 small Thai or 2 French)'
  ...
  - group: 'Spice & funk'
    ...
    note: '(1 tsp)'
  - group: 'Spice & funk'
    item: 'coriander seeds, toasted'
    qty: 4
    unit: 'g'
    note: '(2 tsp)'
  - group: 'Spice & funk'
    item: 'cumin seeds, toasted'
    qty: 2
    unit: 'g'
    note: '(1 tsp)'
  - group: 'Spice & funk'
    item: 'shrimp paste (kapi), toasted'
    qty: 12
    unit: 'g'
    note: '(2 tsp)'
  - group: 'Spice & funk'
